...
Bast sends optional anonymous telemetry to help improve the tool. This includes version, platform, and usage events. No hostnames, keys, project IDs, or SSH config contents are collected by default.
