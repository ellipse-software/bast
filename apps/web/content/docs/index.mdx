...
- Sync VMs from [GCP](/docs/features/gcp), [AWS](/docs/features/aws), and [Azure](/docs/features/azure). GCP and Azure sync require the nightly channel.
...
| `bast sync gcp` | Import GCP VMs into Bast (nightly only) |
| `bast sync aws` | Import Amazon EC2 instances into Bast |
| `bast sync azure` | Import Azure Linux VMs into Bast (nightly only) |
