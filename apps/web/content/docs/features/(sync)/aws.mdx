...
<Callout type="warn" title="Nightly only">
AWS sync is currently available on the [nightly channel](/docs/reference/install#nightly-channel) only. It is not in stable releases yet.
</Callout>
