...
The **Sync** tab (`4`) imports [Hetzner Cloud](https://docs.hetzner.cloud/) servers into Bast. Synced hosts show up in the host picker under **Hetzner Cloud**. Bast talks to Hetzner over the Cloud REST API and does not require the `hcloud` CLI.
