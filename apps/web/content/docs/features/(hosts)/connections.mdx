...
For cloud-synced hosts, Bast may print muted progress lines under the banner while it prepares access. This includes GCP key registration, AWS EC2 Instance Connect, Azure Microsoft Entra certificate requests, Box SSH key authorization, Upstash Box API-key SSH, and Railway SSH key registration. See the [GCP](/docs/features/gcp), [AWS](/docs/features/aws), [Azure](/docs/features/azure), [box.ascii.dev](/docs/features/box), [Upstash Box](/docs/features/upstash), and [Railway](/docs/features/railway) pages for exact behavior.
