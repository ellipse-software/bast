...
Hosts imported from [GCP](/docs/features/gcp), [AWS](/docs/features/aws), or [Azure](/docs/features/azure) are read-only for connection settings and grouping. You can still favorite or hide them. Disconnect the provider in the Sync tab to remove them. Bast prepares provider-specific SSH access immediately before connecting.
