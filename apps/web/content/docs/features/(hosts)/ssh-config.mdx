...
Presentation metadata (groups, tags, colors, notes, favorites, recency) lives in `~/.config/bast/state.json`. Connection settings live in SSH config files where they belong.
