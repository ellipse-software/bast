...
| `n` | New VM on a provider group that supports create (Box, Upstash, Railway) |
...
See [GCP](/docs/features/gcp) / [AWS](/docs/features/aws) / [Azure](/docs/features/azure) / [box.ascii.dev](/docs/features/box) / [Upstash Box](/docs/features/upstash) / [Railway](/docs/features/railway) for cloud host import.
