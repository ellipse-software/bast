...
| `n` | New VM on a provider group that supports create (Box, Upstash, Fly) |
...
See [GCP](/docs/features/gcp) / [AWS](/docs/features/aws) / [Azure](/docs/features/azure) / [box.ascii.dev](/docs/features/box) / [Upstash Box](/docs/features/upstash) / [Fly.io](/docs/features/fly) for cloud host import.
