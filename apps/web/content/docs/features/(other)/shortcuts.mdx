...
| `n` | New VM on a provider group that supports create (Box, Upstash, DigitalOcean) |
...
See [GCP](/docs/features/gcp) / [AWS](/docs/features/aws) / [Azure](/docs/features/azure) / [DigitalOcean](/docs/features/digitalocean) / [box.ascii.dev](/docs/features/box) / [Upstash Box](/docs/features/upstash) for cloud host import.
