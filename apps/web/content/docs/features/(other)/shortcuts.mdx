...
| `n` | New VM on a provider group that supports create (Box) |
...
| Click / tap | Select a menu item; click again to run. The primary button runs immediately |
...
See [GCP](/docs/features/gcp) / [AWS](/docs/features/aws) / [Azure](/docs/features/azure) / [box.ascii.dev](/docs/features/box) for cloud host import.
