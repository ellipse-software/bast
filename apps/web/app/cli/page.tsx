...
export const metadata = createPageMetadata({
  title: "Bast.sh CLI",
  description:
    "Install the official Bast.sh CLI with Homebrew, WinGet, or the install script. Automate SSH hosts and keys with bast --json.",
  path: cliPath,
});
  ...
  return (
    <MarketingShell version={version}>
      ...
      <p className="mb-10 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">
        ...
        It is published via Homebrew, WinGet, and the bast.sh install scripts.
        Agents should call <code className="text-foreground">bast --json</code>{" "}
        rather than driving the TUI.
      </p>
