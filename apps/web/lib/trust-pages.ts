...
export const aboutPage = {
  ...
  paragraphs: [
    ...
    "Bast does not replace OpenSSH and does not invent a second host database. Connection settings stay in ~/.ssh/config. Bast adds a picker, groups, tags, notes, favorites, a key manager, dual-pane SFTP, optional encrypted Vault sync, and read-only imports from GCP, AWS, Azure, box.ascii.dev, Upstash Box, and Hetzner Cloud.",
...
- Import GCP, AWS, Azure, box.ascii.dev, Upstash Box, or Hetzner Cloud hosts
