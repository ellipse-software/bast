...
export const syncSshHostsGuide: GuidePage = {
  ...
  description:
    "Sync SSH hosts and keys between macOS, Linux, and Windows 11 devices with Bast vault. End-to-end encryption on your machine, OpenSSH config stays local, no GUI account lock-in.",
  keywords: [
    "sync SSH hosts",
    "sync SSH config",
    "SSH config sync",
  ...
  solution: [
    ...
    <>
      ...
      DigitalOcean, box.ascii.dev, or Upstash Box per machine so cloud credentials stay
      where they belong.
    </>,
  ],
