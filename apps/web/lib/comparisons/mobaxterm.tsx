...
export const mobaxtermComparison: ComparisonCaseStudy = {
  ...
  diffRows: [
    ...
    {
      topic: "Cloud hosts",
      bast: "GCP, AWS, Azure, DigitalOcean, and box.ascii.dev via provider CLIs",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        <>
          Bast can import live hosts from GCP, AWS, Azure, DigitalOcean, and box.ascii.dev through the CLIs you
