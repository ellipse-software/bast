...
export const termiusComparison: ComparisonCaseStudy = {
  ...
  diffRows: [
    ...
    {
      topic: "Cloud hosts",
      bast: "Import from GCP, AWS, Azure, box.ascii.dev, and Fly.io via their CLIs",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        <>
          Bast imports live inventory from GCP, AWS, Azure, box.ascii.dev, and Fly.io through each
