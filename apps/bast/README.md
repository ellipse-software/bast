...
Stable and nightly binaries are built for supported macOS and Linux architectures by the repository's release workflows. Installation options and channel behavior are documented in the [installation guide](https://bast.sh/docs/reference/install).
